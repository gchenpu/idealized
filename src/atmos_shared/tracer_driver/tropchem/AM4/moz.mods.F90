...
!--------------------------------------------------------------
  ...
  if( astat /= 0 ) then
     ...
     call endrun
      ...
      integer, parameter :: rid_uo_o2 = 42
      integer, parameter :: rid_o1d_n2 = 44
      integer, parameter :: rid_o1d_o2 = 45
      integer, parameter :: rid_ol_o1d = 46
      integer, parameter :: rid_op_ho2 = 49
      integer, parameter :: rid_uno2_no3 = 54
      integer, parameter :: rid_un2o5 = 55
      integer, parameter :: rid_uoh_no2 = 57
      integer, parameter :: rid_uoh_hno3 = 58
      integer, parameter :: rid_uho2_no2 = 60
      integer, parameter :: rid_uhno4 = 62
      integer, parameter :: rid_op_mo2 = 65
      integer, parameter :: rid_uco_oha = 72
      integer, parameter :: rid_uco_ohb = 73
      integer, parameter :: rid_ol_oh = 77
      integer, parameter :: rid_ol_ho2 = 78
      integer, parameter :: rid_uho2_ho2 = 79
      integer, parameter :: rid_uoh_c3h6 = 84
      integer, parameter :: rid_ol_c3h6 = 85
      integer, parameter :: rid_op_po2 = 87
      integer, parameter :: rid_op_ch3co3 = 92
      integer, parameter :: rid_upan_f = 93
      integer, parameter :: rid_upan_b = 97
      integer, parameter :: rid_ol_isop = 99
      integer, parameter :: rid_op_c2h5o2 = 101
      integer, parameter :: rid_uoh_c2h4 = 106
      integer, parameter :: rid_ol_c2h4 = 110
      integer, parameter :: rid_op_isopo2 = 113
      integer, parameter :: rid_ol_mvk = 119
      integer, parameter :: rid_ol_macr = 121
      integer, parameter :: rid_op_macro2 = 122
      integer, parameter :: rid_op_mco3 = 129
      integer, parameter :: rid_umpan_f = 135
      integer, parameter :: rid_umpan_b = 136
      integer, parameter :: rid_ol_terp = 138
      integer, parameter :: rid_n2o5h = 140
      integer, parameter :: rid_no3h = 141
      integer, parameter :: rid_op_c3h7o2 = 145
      integer, parameter :: rid_uoh_acet = 149
      integer, parameter :: rid_op_ro2 = 150
      integer, parameter :: rid_op_xo2 = 164
      integer, parameter :: rid_uoh_xooh = 170
      integer, parameter :: rid_uoh_dms = 180
      integer, parameter :: rid_nh3h = 182
