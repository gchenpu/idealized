...
# compile and run scripts are created in workdir (default=./workdir)
...
#model = fmspy.mo.FmsModel(name="fullrad", monthslist='( 0   0   0 )', dayslist='( 365 365 365 )', dt_atmos=600, \
#                          queue_cmd="qsub", walltime="06:00:00", nnodes=1, ncores=16, nthreads=2)

#model = fmspy.mo.FmsModel(name="gray", monthslist='( 0   0   0   0 )', dayslist='( 365 365 365 365 )', dt_atmos=600, \
#                          queue_cmd="qsub", nnodes=1, ncores=16, nthreads=2)

#model = fmspy.mo.FmsModel(name='hs', monthslist='( 0   0   0   0 )', dayslist='( 365 365 365 365 )', dt_atmos=1800, \
#                          queue_cmd="qsub", nnodes=1, ncores=16, nthreads=2)

model = fmspy.mo.FmsModel(name='hs_with_clouds', monthslist='( 0 )', dayslist='( 1460 )', dt_atmos=1800, \
                          queue_cmd="qsub", nnodes=1, ncores=16, nthreads=2)

#model = fmspy.mo.FmsModel(name='hs_with_clouds', compile_opt="debug", monthslist='( 0 )', dayslist='( 1460 )', dt_atmos=1800, \
#                          queue_cmd="qsub", nnodes=1, ncores=16, nthreads=2)
