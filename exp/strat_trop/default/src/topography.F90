...
use gaussian_topog_mod, only: gaussian_topog_init, sine_topog_init, get_gaussian_topog, get_sine_topog
...
public :: topography_init,                 &
          ...
          gaussian_topog_init, sine_topog_init, get_gaussian_topog, get_sine_topog
